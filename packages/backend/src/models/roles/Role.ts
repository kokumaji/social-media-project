...
export const registerRole = async (roleName: string, permissionLevel: PermissionLevel, publicBadge: boolean, obtainable: boolean) => {
    ...
    const newRole = new Role({roleName, permissionLevel, publicBadge, obtainable});
